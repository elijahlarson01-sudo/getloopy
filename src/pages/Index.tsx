      ...
      <section className="relative px-4 py-20 md:py-32 overflow-hidden">
        ...
        <div className="container max-w-6xl mx-auto relative z-10">
          <div className="text-center space-y-8">
            <Badge className="mb-4 px-4 py-2 text-sm font-semibold bg-gradient-to-r from-primary/20 to-accent/20 border-primary/30">
              <Zap className="w-4 h-4 mr-2" />
              The Duolingo for Deep Knowledge
            </Badge>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              <Button variant="gradient" size="lg" className="group">
                Start Learning Free
                <Target className="ml-2 w-5 h-5 group-hover:rotate-90 transition-transform" />
              </Button>
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 pt-8 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>5M+ practice sessions</span>
              </div>
              <div className="flex items-center gap-2">
